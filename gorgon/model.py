...
class Item(BaseGorgonObject, IconMixin):
  ...
  def __init__(self, name=None, description=None, id=None, required_appearance=None, skill_reqs=None, value=None, effects=None, slot=None, icon=None, version=None, keywords=None, stack_size=None, **kwargs):
...
class Skill(BaseGorgonObject):
  def __init__(self,id=None, name=None, description=None, combat=False, maxlevel=None, rewards=None, advtable=None, xptable=None, parents=None, **kwargs):
